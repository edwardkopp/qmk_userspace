...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAT] = LAYOUT_preonic_grid(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        QK_BOOT, KC_VOLU, XXXXXXX, KC_WH_U, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, MS_UP,   KC_END,  KC_MPRV, KC_DEL,
        KC_ESC,  KC_MUTE, MS_ACL1, KC_WH_D, MS_BTN1, XXXXXXX, XXXXXXX, MS_LEFT, MS_DOWN, MS_RGHT, KC_MPLY, KC_ENT,
