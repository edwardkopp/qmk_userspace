...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOL] = LAYOUT_voyager(
        ...
        _______, KC_BSLS, KC_PIPE, KC_PLUS, KC_EQL,  KC_UNDS, KC_MINS, KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, _______,
                                            _______, _______, EK_MOD,  _______
    ),
    [_NAV] = LAYOUT_voyager(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        KC_INS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   XXXXXXX, XXXXXXX, KC_HOME, KC_UP,   KC_END,  XXXXXXX, KC_DEL,
        KC_PAUS, KC_F5,   KC_F6,   KC_F7,   KC_F8,   XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, KC_ENT,
        _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, KC_PGUP, XXXXXXX, KC_PGDN, XXXXXXX, _______,
                                            _______, EK_MOD,  _______, _______
    ),
    [_RAT] = LAYOUT_voyager(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_MS_U, KC_END,  XXXXXXX, KC_DEL,
        KC_ESC,  XXXXXXX, KC_ACL1, KC_WH_D, KC_BTN1, EK_MOD,  EK_MOD,  KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX, KC_ENT,
        _______, XXXXXXX, XXXXXXX, KC_BTN3, KC_BTN2, XXXXXXX, XXXXXXX, KC_PGUP, KC_PSCR, KC_PGDN, XXXXXXX, _______,
                                            _______, _______, _______, _______
    ),
    [_MOD] = LAYOUT_voyager(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, KC_LGUI, KC_CAPS, _______, _______, KC_CAPS, KC_LGUI, _______, _______, _______,
        _______, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, _______, _______, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, _______,
        _______, _______, KC_VOLU, KC_MUTE, KC_VOLD, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
                                            _______, _______, _______, _______
    )
};
