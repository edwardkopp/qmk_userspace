...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAT] = LAYOUT_voyager(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        XXXXXXX, KC_VOLU, XXXXXXX, EK_WH_U, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, EK_MS_U, KC_END,  KC_MPRV, KC_DEL,
        KC_ESC,  KC_MUTE, XXXXXXX, EK_WH_D, EK_BTN1, XXXXXXX, XXXXXXX, EK_MS_L, EK_MS_D, EK_MS_R, KC_MPLY, KC_ENT,
        _______, KC_VOLD, XXXXXXX, EK_BTN3, EK_BTN2, XXXXXXX, XXXXXXX, KC_PGUP, KC_PSCR, KC_PGDN, KC_MNXT, _______,
                                            _______, _______, _______, _______
    ),
    [_RMOD] = LAYOUT_voyager(
        ...
        EK_XXXX, _______, _______, _______, _______, _______, EK_GAS,  EK_CG,   EK_CA,   EK_GA,   EK_____, _______,
                                            _______, _______, _______, _______
    ),
    [_LMOD] = LAYOUT_voyager(
        ...
        _______, EK_____, EK_GA,   EK_CA,   EK_CG,   EK_GAS,  _______, _______, _______, _______, _______, EK_XXXX,
                                            _______, _______, _______, _______
    )
};
